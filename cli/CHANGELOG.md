...
## [0.6.0](https://github.com/apetcho/grain-lang/compare/cli-v0.5.13...cli-v0.6.0) (2023-08-02)


### ⚠ BREAKING CHANGES

* **cli:** Ensure `--use-start-section` can only be used with compile command ([#1871](https://github.com/apetcho/grain-lang/issues/1871))
...
* **cli:** Simplify version output ([#1291](https://github.com/apetcho/grain-lang/issues/1291))
...
* **ci:** Link all versions during release ([#1290](https://github.com/apetcho/grain-lang/issues/1290)) ([ceb8dac](https://github.com/apetcho/grain-lang/commit/ceb8dac2e3d3bf7eb92f91daf29173a779a4aa7e))
...
* **cli:** Ensure `--use-start-section` can only be used with compile command ([#1871](https://github.com/apetcho/grain-lang/issues/1871)) ([d9227d7](https://github.com/apetcho/grain-lang/commit/d9227d7770b73338362d5699d2382e029fe3a5dc))
...
* **compiler:** Increase JS stack size ([#1532](https://github.com/apetcho/grain-lang/issues/1532)) ([9d1ff1f](https://github.com/apetcho/grain-lang/commit/9d1ff1f427f2b2a92aa7958cf84b2d1026b1bac5))
...
* **cli:** Simplify version output ([#1291](https://github.com/apetcho/grain-lang/issues/1291)) ([97f99f4](https://github.com/apetcho/grain-lang/commit/97f99f4a53c9434175d8bd8bac3c08cdd4257c77))
