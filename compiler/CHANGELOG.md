...
## [0.6.0](https://github.com/apetcho/grain-lang/compare/compiler-v0.5.13...compiler-v0.6.0) (2023-08-02)
...
* **stdlib:** Use explicit exports for Pervasives ([#1301](https://github.com/apetcho/grain-lang/issues/1301))
* **stdlib:** Remove `sum` function from the List module ([#1300](https://github.com/apetcho/grain-lang/issues/1300))
* **compiler:** Remove `--lsp` flag from grainc executable
* **lsp:** Replaced one-off LSP command with persistent LSP server ([#1131](https://github.com/apetcho/grain-lang/issues/1131))
* **cli:** Show all global options within help for every command ([#1285](https://github.com/apetcho/grain-lang/issues/1285))
* **cli:** Remove graceful flag & behavior ([#1275](https://github.com/apetcho/grain-lang/issues/1275))
* **compiler:** Refactor HeapAllocated/StackAllocated into Managed/Unmanaged ([#1268](https://github.com/apetcho/grain-lang/issues/1268))
* **compiler:** Replace optimization levels with compilation profiles ([#1270](https://github.com/apetcho/grain-lang/issues/1270))
* **grainfmt:** Replace `--in-place` flag with `-o` flag
* **grainfmt:** Remove stdin formatting support
* **compiler:** Arbitrary-Precision Integer Arithmetic ([#1167](https://github.com/apetcho/grain-lang/issues/1167))
* Switch from yarn to npm ([#1226](https://github.com/apetcho/grain-lang/issues/1226))
* Drop node 14 support ([#1092](https://github.com/apetcho/grain-lang/issues/1092))
* **compiler:** Selectively include functions in the global function table ([#1183](https://github.com/apetcho/grain-lang/issues/1183))
* **compiler:** Add interface for compile module to hide resume
* **compiler:** Disallow end-of-line before `=>` ([#1178](https://github.com/apetcho/grain-lang/issues/1178))
* **compiler:** Stack-allocated Chars ([#1103](https://github.com/apetcho/grain-lang/issues/1103))
* **stdlib:** Align Buffer's `addStringSlice` API with String's `slice` ([#1136](https://github.com/apetcho/grain-lang/issues/1136))
* **graindoc:** Add `--current-version` flag, required for since/history attributes ([#1116](https://github.com/apetcho/grain-lang/issues/1116))
* **compiler:** Remove decRefIgnoreZeros ([#1068](https://github.com/apetcho/grain-lang/issues/1068))
* **compiler:** Add `--memory-base` flag ([#1115](https://github.com/apetcho/grain-lang/issues/1115))
* **compiler:** Re-implement Grain parser ([#1033](https://github.com/apetcho/grain-lang/issues/1033))
...
* **compiler:** Add `--memory-base` flag ([#1115](https://github.com/apetcho/grain-lang/issues/1115)) ([0680826](https://github.com/apetcho/grain-lang/commit/068082663c4387c3ab54c052869e9b9a06b87e26))
* **compiler:** Add `[@unsafe](https://github.com/unsafe)` attribute for low-level code ([#1074](https://github.com/apetcho/grain-lang/issues/1074)) ([212faca](https://github.com/apetcho/grain-lang/commit/212faca9a8363002cfc0cb4e3ea293180cbe5b1c))
...
* **compiler:** Add warning for calls to IntXX.fromNumber and FloatXX.fromNumber with literal integers/floats ([#1218](https://github.com/apetcho/grain-lang/issues/1218)) ([2fb86e5](https://github.com/apetcho/grain-lang/commit/2fb86e538a9d38241d6c149cec1a290817795b4b))
...
* **compiler:** Allow [@external](https://github.com/external)Name attribute for foreign names ([#1060](https://github.com/apetcho/grain-lang/issues/1060)) ([f4c1311](https://github.com/apetcho/grain-lang/commit/f4c13115ef2eb589f035c31370e56a12bdc2e10c))
...
* **compiler:** Allow a newline character before a match guard ([#1063](https://github.com/apetcho/grain-lang/issues/1063)) ([bf41a9c](https://github.com/apetcho/grain-lang/commit/bf41a9cf585c63eb2482c7d94d9c615428bc8435))
* **compiler:** Allow compilation of empty programs ([#1336](https://github.com/apetcho/grain-lang/issues/1336)) ([32df14b](https://github.com/apetcho/grain-lang/commit/32df14b33325c39fd98c452fc2687b788ec35264))
* **compiler:** Allow custom infix operators ([#1419](https://github.com/apetcho/grain-lang/issues/1419)) ([cc9b8b5](https://github.com/apetcho/grain-lang/commit/cc9b8b5f251268c59ff6739436bd3b8881e8fd56))
* **compiler:** Allow function re-exports to use regular call instruction ([#1176](https://github.com/apetcho/grain-lang/issues/1176)) ([afce3aa](https://github.com/apetcho/grain-lang/commit/afce3aaa5382cde54b1e8fd9be3d2ee86daedbbb))
...
* **compiler:** Allow newline in or-patterns ([#1323](https://github.com/apetcho/grain-lang/issues/1323)) ([8fe8247](https://github.com/apetcho/grain-lang/commit/8fe8247ec6c08e04575b42281716eb34c46af97f))
* **compiler:** Arbitrary-Precision Integer Arithmetic ([#1167](https://github.com/apetcho/grain-lang/issues/1167)) ([6f34de2](https://github.com/apetcho/grain-lang/commit/6f34de214b28358ea1df553685fa3a19336ddba9))
...
* **compiler:** Call known functions across module boundaries ([#1175](https://github.com/apetcho/grain-lang/issues/1175)) ([b2d7440](https://github.com/apetcho/grain-lang/commit/b2d744034ec7e0601554531c910e9d0f5451d464))
...
* **compiler:** Cleaner wasm output for low-level wasm types ([#1158](https://github.com/apetcho/grain-lang/issues/1158)) ([88060dd](https://github.com/apetcho/grain-lang/commit/88060ddb8119e2998d91f4d6770a1cfd101936cf))
* **compiler:** Consolidate exe & js modes ([fc61950](https://github.com/apetcho/grain-lang/commit/fc6195013457dd29f78951322bfaf2ae27c1bdd2))
* **compiler:** Convert `runtime/dataStructures.gr` to primitives ([#1145](https://github.com/apetcho/grain-lang/issues/1145)) ([2d43b28](https://github.com/apetcho/grain-lang/commit/2d43b286141df75f6b92300e48d2bc4804014872))
...
* **compiler:** Don't close over global values ([#1134](https://github.com/apetcho/grain-lang/issues/1134)) ([e8caec6](https://github.com/apetcho/grain-lang/commit/e8caec6c2a5892e955c8827b18d8d436bebe6073))
...
* **compiler:** Inline all primitives ([#1076](https://github.com/apetcho/grain-lang/issues/1076)) ([c227130](https://github.com/apetcho/grain-lang/commit/c2271307b7220d54dc1c252dfc4ee5532f68dd29))
...
* **compiler:** Name globals in wasm output ([#1184](https://github.com/apetcho/grain-lang/issues/1184)) ([51170e7](https://github.com/apetcho/grain-lang/commit/51170e7c892680f9c730b7f93cf744ffd6b7c15a))
...
* **compiler:** Re-implement Grain parser ([#1033](https://github.com/apetcho/grain-lang/issues/1033)) ([9dc3c96](https://github.com/apetcho/grain-lang/commit/9dc3c96f87a0b2affe9db36e1b03360d198f79f1))
...
* **compiler:** Reduce closure sizes by utilizing `$self` argument when possible ([#1152](https://github.com/apetcho/grain-lang/issues/1152)) ([ba6a84c](https://github.com/apetcho/grain-lang/commit/ba6a84cea191cf3c7932287c29b198001d490146))
...
* **compiler:** Refactor exports ([#1244](https://github.com/apetcho/grain-lang/issues/1244)) ([4637667](https://github.com/apetcho/grain-lang/commit/4637667cd669c0988cd01c2957534c6a35a3146c))
...
* **compiler:** Replace optimization levels with compilation profiles ([#1270](https://github.com/apetcho/grain-lang/issues/1270)) ([1a27c12](https://github.com/apetcho/grain-lang/commit/1a27c127e8f0318c21fec7ab358ee8e1ad2378e9))
...
* **compiler:** Selectively include functions in the global function table ([#1183](https://github.com/apetcho/grain-lang/issues/1183)) ([67575f7](https://github.com/apetcho/grain-lang/commit/67575f712557bc36531f6e40044d1bbfff2454ff))
...
* **compiler:** Stack-allocated Chars ([#1103](https://github.com/apetcho/grain-lang/issues/1103)) ([095385e](https://github.com/apetcho/grain-lang/commit/095385e7c67bbc7a417a21acaf6f1c498c75ce63))
...
* **compiler:** Support pattern aliases ([#1174](https://github.com/apetcho/grain-lang/issues/1174)) ([9ed093b](https://github.com/apetcho/grain-lang/commit/9ed093be353895bdde8282ee1681089d5fac68ab))
* **compiler:** Support pattern matching "or" patterns ([#1173](https://github.com/apetcho/grain-lang/issues/1173)) ([0fb29c4](https://github.com/apetcho/grain-lang/commit/0fb29c4016e1b24b9e3b3b640cc9914b921ec376))
* **compiler:** Support record field updating assignment ([#1320](https://github.com/apetcho/grain-lang/issues/1320)) ([cc5519c](https://github.com/apetcho/grain-lang/commit/cc5519ce36418623b05d297d577c2325ad9cbc7a))
...
* **compiler:** Type aliases ([#995](https://github.com/apetcho/grain-lang/issues/995)) ([bc648ce](https://github.com/apetcho/grain-lang/commit/bc648ce98f1263cdb4163f7fd620de75771848ab))
* **compiler:** Unicode-aware lexing ([#1342](https://github.com/apetcho/grain-lang/issues/1342)) ([6dc0dd1](https://github.com/apetcho/grain-lang/commit/6dc0dd1bc80bbfa9da41f82e9f89569d5f0e6d01))
* **compiler:** Upgrade binaryen to 0.15.0 to support Mac M1 arch ([#1151](https://github.com/apetcho/grain-lang/issues/1151)) ([fc61950](https://github.com/apetcho/grain-lang/commit/fc6195013457dd29f78951322bfaf2ae27c1bdd2))
* **compiler:** Use symbol for equals sign ([#1128](https://github.com/apetcho/grain-lang/issues/1128)) ([3d7fc57](https://github.com/apetcho/grain-lang/commit/3d7fc5742ad3016d60e14112fdd68de02fc147f1))
* **graindoc:** Add `--current-version` flag, required for since/history attributes ([#1116](https://github.com/apetcho/grain-lang/issues/1116)) ([0f681ea](https://github.com/apetcho/grain-lang/commit/0f681ea140749395f3ce99a460f30778537183ac))
...
* **graindoc:** Allow directory input & output ([#1263](https://github.com/apetcho/grain-lang/issues/1263)) ([d4cb8ab](https://github.com/apetcho/grain-lang/commit/d4cb8abcb4accafeb3cae0bac77eee9a365e464d))
...
* **grainfmt:** Allow directory input & output ([#1274](https://github.com/apetcho/grain-lang/issues/1274)) ([d3e7a33](https://github.com/apetcho/grain-lang/commit/d3e7a33b01352a9c2bcc3b17a5b2995451d92221))
* **grainfmt:** Drastically improve performance ([#1042](https://github.com/apetcho/grain-lang/issues/1042)) ([9bc7a55](https://github.com/apetcho/grain-lang/commit/9bc7a55a525c8018e9d915cf94af2f2486a21e27))
* **grainfmt:** Replace `--in-place` flag with `-o` flag ([d3e7a33](https://github.com/apetcho/grain-lang/commit/d3e7a33b01352a9c2bcc3b17a5b2995451d92221))
...
* Implement Pervasives.compare ([#1399](https://github.com/apetcho/grain-lang/issues/1399)) ([ebd87e4](https://github.com/apetcho/grain-lang/commit/ebd87e4308a8950fd95f060ebc446833b064237c))
* **lsp:** Replaced one-off LSP command with persistent LSP server ([#1131](https://github.com/apetcho/grain-lang/issues/1131)) ([df91849](https://github.com/apetcho/grain-lang/commit/df91849bd65a729fe4e0b03f51bc6d28017935cb))
...
* **stdlib:** Add `charCodeAt` function to String module ([#1376](https://github.com/apetcho/grain-lang/issues/1376)) ([c3abbc9](https://github.com/apetcho/grain-lang/commit/c3abbc991c8b05e3de20e670d2bc3e491feebf8a))
...
* **stdlib:** Add `lastIndexOf` function to String module ([#1372](https://github.com/apetcho/grain-lang/issues/1372)) ([b73d9bf](https://github.com/apetcho/grain-lang/commit/b73d9bf9ff3291b83e6f4263e392395d04dc9995))
...
* **stdlib:** Add Conv.wasmI32ToNumber function ([#978](https://github.com/apetcho/grain-lang/issues/978)) ([c93ade8](https://github.com/apetcho/grain-lang/commit/c93ade873b51acca556e19a7483a5f29b4b6caa9))
* **stdlib:** Add cycle function to Array module ([#993](https://github.com/apetcho/grain-lang/issues/993)) ([c595622](https://github.com/apetcho/grain-lang/commit/c595622b28366655dfd5447270e8f9fc3f988a67))
* **stdlib:** Add module for pseudo-random number generation ([#921](https://github.com/apetcho/grain-lang/issues/921)) ([db1fa4e](https://github.com/apetcho/grain-lang/commit/db1fa4e491d35bb582beaba12157884647384a77))
* **stdlib:** Add number constants to number libraries ([#1331](https://github.com/apetcho/grain-lang/issues/1331)) ([f640ec2](https://github.com/apetcho/grain-lang/commit/f640ec20aa507c83c9cde290b911d0adcb4e8254))
...
* **stdlib:** Add reverse function to String module ([#1027](https://github.com/apetcho/grain-lang/issues/1027)) ([df761db](https://github.com/apetcho/grain-lang/commit/df761db55b3e14e31190090ae008ce5047135c09))
* **stdlib:** Add rotate function in Array module ([#838](https://github.com/apetcho/grain-lang/issues/838)) ([98fc577](https://github.com/apetcho/grain-lang/commit/98fc577ee754317cd2421bfaa8e3c1e049488949))
* **stdlib:** Add sign function to Number module ([#1079](https://github.com/apetcho/grain-lang/issues/1079)) ([b6483d5](https://github.com/apetcho/grain-lang/commit/b6483d5046cd1b6b89a717a925594d3b20b05837))
* **stdlib:** Add sort function to Array module ([#1012](https://github.com/apetcho/grain-lang/issues/1012)) ([9091930](https://github.com/apetcho/grain-lang/commit/9091930344224925bb7b2e1ef6f879c79a5c2f62))
* **stdlib:** Add string trim functions to String module ([#951](https://github.com/apetcho/grain-lang/issues/951)) ([e55de8f](https://github.com/apetcho/grain-lang/commit/e55de8fc0335b45252da9741a80b46a702cdb5b6))
* **stdlib:** Add unsigned versions of Int32/Int64 comparison operations ([#831](https://github.com/apetcho/grain-lang/issues/831)) ([5f20868](https://github.com/apetcho/grain-lang/commit/5f20868e7b6e3f52d62c8531d99d1130ca84961e))
...
* **stdlib:** Implement `isFloat`, `isInteger` & `isRational` in Number module ([#1393](https://github.com/apetcho/grain-lang/issues/1393)) ([0af0669](https://github.com/apetcho/grain-lang/commit/0af066993a2b80e417d2c625b27fd11cb1f1f55f))
...
* **stdlib:** Implement List.sort via mergesort ([#1014](https://github.com/apetcho/grain-lang/issues/1014)) ([a076e20](https://github.com/apetcho/grain-lang/commit/a076e200013114ccf16c2e6cbe814af1ec09c1ce))
* **stdlib:** Implement List.zip, List.unzip, List.zipWith, Array.reduceRight, Array.zipWith ([#1363](https://github.com/apetcho/grain-lang/issues/1363)) ([3e7c147](https://github.com/apetcho/grain-lang/commit/3e7c147fea2d2fb8b7c5a3d6b3eb1453f2861e36))
* **stdlib:** Implement mutable/immutable priority queues ([#1397](https://github.com/apetcho/grain-lang/issues/1397)) ([244be1b](https://github.com/apetcho/grain-lang/commit/244be1b7254caf0b451902ac56413382eb196747))
* **stdlib:** Implement Number.sin and Number.cos ([#1343](https://github.com/apetcho/grain-lang/issues/1343)) ([9357126](https://github.com/apetcho/grain-lang/commit/93571267b7df53e1cb9f61eaebf8748885e7392c))
...
* **stdlib:** Marshal ([#1352](https://github.com/apetcho/grain-lang/issues/1352)) ([d659de2](https://github.com/apetcho/grain-lang/commit/d659de2d92260f7726164876827c639bfd9d0590))
* **stdlib:** Number.parseInt ([#1051](https://github.com/apetcho/grain-lang/issues/1051)) ([abafb58](https://github.com/apetcho/grain-lang/commit/abafb587e54219a32ed77ba09863bb2d6a80bac8))
...
* **cli:** Ensure parent flags are inherited by the format command ([d3e7a33](https://github.com/apetcho/grain-lang/commit/d3e7a33b01352a9c2bcc3b17a5b2995451d92221))
* **cli:** Show all global options within help for every command ([#1285](https://github.com/apetcho/grain-lang/issues/1285)) ([1357e16](https://github.com/apetcho/grain-lang/commit/1357e162f7e939db21468186d16e6d720b557a57))
* **compiler:** Account for config that is not digestable ([#1098](https://github.com/apetcho/grain-lang/issues/1098)) ([b58323f](https://github.com/apetcho/grain-lang/commit/b58323f1764f4d870875b8c4ef19f9861b4188ad))
* **compiler:** Allow defining _start when using --use-start-section ([#1349](https://github.com/apetcho/grain-lang/issues/1349)) ([944f71c](https://github.com/apetcho/grain-lang/commit/944f71ca8080b8a3228d27893b2fd5b84e4b6189))
...
* **compiler:** Allow modules to re-export imported types containing generics ([#1019](https://github.com/apetcho/grain-lang/issues/1019)) ([003cb1e](https://github.com/apetcho/grain-lang/commit/003cb1e10ca51c3f16d2155581eb8dccdde3ce5c))
* **compiler:** Apply correct allocation type to numbers ([#1140](https://github.com/apetcho/grain-lang/issues/1140)) ([b9e9d59](https://github.com/apetcho/grain-lang/commit/b9e9d59143f529f7c0ae100b048988e6ba0e8d54))
...
* **compiler:** Apply list location to outer node ([#1387](https://github.com/apetcho/grain-lang/issues/1387)) ([06e79a8](https://github.com/apetcho/grain-lang/commit/06e79a80e5e61e5a8654654dfa15310a1bc363ea))
* **compiler:** Apply optimization flag at link stage ([#1099](https://github.com/apetcho/grain-lang/issues/1099)) ([49dac79](https://github.com/apetcho/grain-lang/commit/49dac797aa4833cc141f7c58d18d80d7cbc6b1c7))
* **compiler:** Avoid module aliases of themselves ([df91849](https://github.com/apetcho/grain-lang/commit/df91849bd65a729fe4e0b03f51bc6d28017935cb))
* **compiler:** Consider invalid CMIs as out of date and recompile ([#1061](https://github.com/apetcho/grain-lang/issues/1061)) ([80da3a9](https://github.com/apetcho/grain-lang/commit/80da3a9667020e4f5f855a0b9da8286508a07275))
* **compiler:** Correct error message for unbound type variables ([#1327](https://github.com/apetcho/grain-lang/issues/1327)) ([762362a](https://github.com/apetcho/grain-lang/commit/762362a06e1676540cd33df8200ea2a6b7006a5e))
...
* **compiler:** Correctly handle underscores in bigint literals ([0af0669](https://github.com/apetcho/grain-lang/commit/0af066993a2b80e417d2c625b27fd11cb1f1f55f))
* **compiler:** Correctly supply locations for types & variants ([9bc7a55](https://github.com/apetcho/grain-lang/commit/9bc7a55a525c8018e9d915cf94af2f2486a21e27))
...
* **compiler:** Ensure main module is included in linker dependency graph ([#996](https://github.com/apetcho/grain-lang/issues/996)) ([d5c6c04](https://github.com/apetcho/grain-lang/commit/d5c6c048d4239ef07fb6ac0a79774d85933cccf9))
* **compiler:** Ensure TExpApp is always expansive in Grain ([ef0a69f](https://github.com/apetcho/grain-lang/commit/ef0a69fb4418d318b3227e5db7e743a026762274))
* **compiler:** Fix binop operator reported location ([#1018](https://github.com/apetcho/grain-lang/issues/1018)) ([422dbcb](https://github.com/apetcho/grain-lang/commit/422dbcb01cd09627c6a5f4494cc7c2e7644e92f0))
* **compiler:** Fix compilation of closure scope mutable destructuring ([#1346](https://github.com/apetcho/grain-lang/issues/1346)) ([bdcdb3c](https://github.com/apetcho/grain-lang/commit/bdcdb3c66a9a60fc44956225491c12cc14250009))
* **compiler:** Fix compilation of functions annotated with alias ([#1293](https://github.com/apetcho/grain-lang/issues/1293)) ([b3e1882](https://github.com/apetcho/grain-lang/commit/b3e188299be6af22bb64cf5ae9a41afa05e4c16f))
* **compiler:** Fix counting of stack size ([#1066](https://github.com/apetcho/grain-lang/issues/1066)) ([f1b3e51](https://github.com/apetcho/grain-lang/commit/f1b3e51580062da9b7e42ec36eb9880b71375cb9))
...
* **compiler:** Fix error message when trying to export a constructor ([#1055](https://github.com/apetcho/grain-lang/issues/1055)) ([54ddb67](https://github.com/apetcho/grain-lang/commit/54ddb671745b554eacc8640b1337a46f423b1cc5))
* **compiler:** fix formatter multiple data bug ([#1282](https://github.com/apetcho/grain-lang/issues/1282)) ([f6fd962](https://github.com/apetcho/grain-lang/commit/f6fd96250dbe95d6b6c56d663f6d7f2704b792b3))
...
* **compiler:** Fix memory leaks when loading from heap values ([#1038](https://github.com/apetcho/grain-lang/issues/1038)) ([7d3402d](https://github.com/apetcho/grain-lang/commit/7d3402db09b6e4e24e49d168e8ddd49044a98df1))
...
* **compiler:** Fix stack/heap number allocation boundary ([#974](https://github.com/apetcho/grain-lang/issues/974)) ([47b0f56](https://github.com/apetcho/grain-lang/commit/47b0f56c00e88ddc6054b8f8f8eea4b21da0c7f7))
...
* **compiler:** Handle let-mut value restriction, such that mutable lets are always expansive ([ef0a69f](https://github.com/apetcho/grain-lang/commit/ef0a69fb4418d318b3227e5db7e743a026762274))
* **compiler:** Inform the compiler that lsp mode is running on a root file ([b58323f](https://github.com/apetcho/grain-lang/commit/b58323f1764f4d870875b8c4ef19f9861b4188ad))
...
* **compiler:** Iterate over guard clauses in typedTreeIter/typedTreeMap ([#1283](https://github.com/apetcho/grain-lang/issues/1283)) ([96e8ecb](https://github.com/apetcho/grain-lang/commit/96e8ecb9e84e54d0640bc775e23e25b93c4dda7c))
* **compiler:** Move Filename usage to Filepath.String & normalize separators ([584bcad](https://github.com/apetcho/grain-lang/commit/584bcad942f91d86c9b328e61f34af6e3cfbd050))
* **compiler:** Move lsp flag into grainc to remove it as a recompilation flag ([b58323f](https://github.com/apetcho/grain-lang/commit/b58323f1764f4d870875b8c4ef19f9861b4188ad))
...
* **compiler:** Preserve all configs when compiling ([#1207](https://github.com/apetcho/grain-lang/issues/1207)) ([d8ff903](https://github.com/apetcho/grain-lang/commit/d8ff9037fc3148384d2157f76e4394322ba4ed58))
...
* **compiler:** Properly apply bindings when executing match guard ([#1039](https://github.com/apetcho/grain-lang/issues/1039)) ([121644b](https://github.com/apetcho/grain-lang/commit/121644be48e66ea1a7ce884ea816fe9af223442c))
* **compiler:** Properly handle corrupted CMIs ([#1314](https://github.com/apetcho/grain-lang/issues/1314)) ([7f97410](https://github.com/apetcho/grain-lang/commit/7f9741016fac55bd63aa74d9bd2fef49dd34d03b))
...
* **compiler:** Properly handle types not imported ([#1329](https://github.com/apetcho/grain-lang/issues/1329)) ([75bbb93](https://github.com/apetcho/grain-lang/commit/75bbb9367a43c923fc97b25ea0ed9315190f5702))
* **compiler:** Properly handle value restriction on function application & mutable vars ([#988](https://github.com/apetcho/grain-lang/issues/988)) ([ef0a69f](https://github.com/apetcho/grain-lang/commit/ef0a69fb4418d318b3227e5db7e743a026762274))
...
* **compiler:** Properly unmark type manifest bodies ([bc648ce](https://github.com/apetcho/grain-lang/commit/bc648ce98f1263cdb4163f7fd620de75771848ab))
...
* **compiler:** Read custom sections in full ([#1243](https://github.com/apetcho/grain-lang/issues/1243)) ([f8a0891](https://github.com/apetcho/grain-lang/commit/f8a0891f253e33153feb2ec20afe6443391a1aa8))
* **compiler:** Refactor WASI polyfill resolution ([#1261](https://github.com/apetcho/grain-lang/issues/1261)) ([a39b48f](https://github.com/apetcho/grain-lang/commit/a39b48ff95f4ef7ce5a4b5454dbc620ae4044c17))
* **compiler:** Remove &lt;id&gt;</id> from default ident printer ([#1056](https://github.com/apetcho/grain-lang/issues/1056)) ([49cd5a0](https://github.com/apetcho/grain-lang/commit/49cd5a08e5d9b2753b47af324b7fb90f4a98b339))
...
* **compiler:** Report binop locations properly ([#1271](https://github.com/apetcho/grain-lang/issues/1271)) ([4b9dd9c](https://github.com/apetcho/grain-lang/commit/4b9dd9c35969cf86f1d2d9a8013b7f6d347c508e))
* **compiler:** Report Win32 instead of Cygwin in JS compiler ([#1251](https://github.com/apetcho/grain-lang/issues/1251)) ([584bcad](https://github.com/apetcho/grain-lang/commit/584bcad942f91d86c9b328e61f34af6e3cfbd050))
* **compiler:** Resolve all modules fully during linking ([#950](https://github.com/apetcho/grain-lang/issues/950)) ([33b33a3](https://github.com/apetcho/grain-lang/commit/33b33a3926cc059a0a759c4ec894fb9f6f03d904))
* **compiler:** Respect stack type when dropping statements ([#1138](https://github.com/apetcho/grain-lang/issues/1138)) ([5a44e93](https://github.com/apetcho/grain-lang/commit/5a44e93ab646f1e9998ce6c23245e41c4bf0019a))
* **compiler:** Supply correct error for unbound record labels ([#1200](https://github.com/apetcho/grain-lang/issues/1200)) ([86e1bc0](https://github.com/apetcho/grain-lang/commit/86e1bc0ba099c5b48ba72e98530a634e15f6bb77))
...
* **compiler:** Support printing tuple types in oprint ([#1324](https://github.com/apetcho/grain-lang/issues/1324)) ([c1d8907](https://github.com/apetcho/grain-lang/commit/c1d89076cad153ed4aa02593f628f4d152ff7139))
* **compiler:** Use option converter for `--profile` argument ([#1432](https://github.com/apetcho/grain-lang/issues/1432)) ([57776f2](https://github.com/apetcho/grain-lang/commit/57776f224904f2d422923a1a947b5acbe435cfa4))
...
* **graindoc:** Add parens around infix operators in titles ([#1303](https://github.com/apetcho/grain-lang/issues/1303)) ([acba9c1](https://github.com/apetcho/grain-lang/commit/acba9c1757688756c3ca98b22a0a159b8d8f9e7d))
* **graindoc:** Avoid singletons when building ordered comments ([#1208](https://github.com/apetcho/grain-lang/issues/1208)) ([3f28e6e](https://github.com/apetcho/grain-lang/commit/3f28e6e226bbd951aedc6f8783203152919c7d08))
* **graindoc:** Enable printing of arrow types ([#1367](https://github.com/apetcho/grain-lang/issues/1367)) ([e2b28ab](https://github.com/apetcho/grain-lang/commit/e2b28ab66ecd9169c27a2680ba5e0fb79e589787))
* **graindoc:** Ensure value_description is resolved to outcome before printing ([#1070](https://github.com/apetcho/grain-lang/issues/1070)) ([5eb05cc](https://github.com/apetcho/grain-lang/commit/5eb05cc2dedc3b933e194be86dd5d3c3656d6490))
...
* **graindoc:** Fix type printing for types and abstract types ([#1238](https://github.com/apetcho/grain-lang/issues/1238)) ([aea3ea9](https://github.com/apetcho/grain-lang/commit/aea3ea9f6b72182dfffb8af4c9af83a444fb6a83))
* **graindoc:** Improve location lookup so re-exports do not crash it ([#1280](https://github.com/apetcho/grain-lang/issues/1280)) ([6e782ee](https://github.com/apetcho/grain-lang/commit/6e782ee146e16aefd3b88441de500d82a20508be))
* **graindoc:** Only extract attributes from Doc comments ([#970](https://github.com/apetcho/grain-lang/issues/970)) ([7b6ee5f](https://github.com/apetcho/grain-lang/commit/7b6ee5f085af89f3db181c8d6c2718ca161f2ead))
* **graindoc:** Preserve indentation in Doc comments during trim ([#1119](https://github.com/apetcho/grain-lang/issues/1119)) ([b8a6d57](https://github.com/apetcho/grain-lang/commit/b8a6d57cce274bfbc2cc16c5b25215b042d4264c))
* **graindoc:** Remove spaces between parens and infix idents ([#1302](https://github.com/apetcho/grain-lang/issues/1302)) ([95e596f](https://github.com/apetcho/grain-lang/commit/95e596fa3fdae5a8a0e07d76ff8c11eeab99e8d7))
* **graindoc:** Remove special idents from receiving parens ([#1104](https://github.com/apetcho/grain-lang/issues/1104)) ([5cb0fda](https://github.com/apetcho/grain-lang/commit/5cb0fda652cad0644f48d8196089430dca1cac0d))
* **graindoc:** Use defined module name throughout generated doc ([#1406](https://github.com/apetcho/grain-lang/issues/1406)) ([c33a777](https://github.com/apetcho/grain-lang/commit/c33a777a93d5e40a081991db5e6ea61ade4fbabc))
...
* **graindoc:** Use value_descriptions and type_declarations defined by the module signature ([#1241](https://github.com/apetcho/grain-lang/issues/1241)) ([5896242](https://github.com/apetcho/grain-lang/commit/5896242c324622f3329c144bd2c9642aade9d049))
...
* **grainfmt:** Break long parameterized types ([bc648ce](https://github.com/apetcho/grain-lang/commit/bc648ce98f1263cdb4163f7fd620de75771848ab))
...
* **grainfmt:** Format CRLF files without error ([#941](https://github.com/apetcho/grain-lang/issues/941)) ([ece7536](https://github.com/apetcho/grain-lang/commit/ece7536b6d20694360257515a6f963f115ed21b3))
* **grainfmt:** Format rational numbers with parens when needed for precedence ([#1385](https://github.com/apetcho/grain-lang/issues/1385)) ([931bb42](https://github.com/apetcho/grain-lang/commit/931bb42b4a8bc610765d871947f7deaef354511b))
...
* **grainfmt:** Handle recursive enums ([7dc77cd](https://github.com/apetcho/grain-lang/commit/7dc77cd3ec28745dfad6cdbd1551c09a82a1ba6b))
* **grainfmt:** Handle source files with no code, only comments ([#1411](https://github.com/apetcho/grain-lang/issues/1411)) ([a435d60](https://github.com/apetcho/grain-lang/commit/a435d60f4c8f8c85ec28ea8a29e76d0ceea0284b))
* **grainfmt:** Improve correctness of formatting ([9bc7a55](https://github.com/apetcho/grain-lang/commit/9bc7a55a525c8018e9d915cf94af2f2486a21e27))
* **grainfmt:** Indent function application args when adding parens ([#1095](https://github.com/apetcho/grain-lang/issues/1095)) ([64af7d3](https://github.com/apetcho/grain-lang/commit/64af7d387dca2fddb9b3d190ccdf5790ec3d8e65))
...
* **grainfmt:** Inform the formatter that it is running against root files ([b58323f](https://github.com/apetcho/grain-lang/commit/b58323f1764f4d870875b8c4ef19f9861b4188ad))
...
* **grainfmt:** Preserve the EOL characters of file ([#1216](https://github.com/apetcho/grain-lang/issues/1216)) ([ef2835a](https://github.com/apetcho/grain-lang/commit/ef2835a5608cb1d5de52b280b6d4fd5b563ce725))
...
* **grainfmt:** Properly handle if/then/else line breaks ([#1217](https://github.com/apetcho/grain-lang/issues/1217)) ([93fd3b5](https://github.com/apetcho/grain-lang/commit/93fd3b5d0a5ccbc11baaab08d0f65ff9ec98aead))
...
* **grainfmt:** Remove parens around annotated types ([#1109](https://github.com/apetcho/grain-lang/issues/1109)) ([0ca66bd](https://github.com/apetcho/grain-lang/commit/0ca66bd43703826f86ef5b28b49d250af219fb0b))
* **grainfmt:** Resugar match lists properly ([7dc77cd](https://github.com/apetcho/grain-lang/commit/7dc77cd3ec28745dfad6cdbd1551c09a82a1ba6b))
* **grainfmt:** Scope the comments in callback lambda closure ([#1090](https://github.com/apetcho/grain-lang/issues/1090)) ([0975580](https://github.com/apetcho/grain-lang/commit/09755801d8598691e4a2884a732c0ed9a9e10a2d))
...
* **grainfmt:** Support PPatOr and PPatAlias ([#1322](https://github.com/apetcho/grain-lang/issues/1322)) ([20050d2](https://github.com/apetcho/grain-lang/commit/20050d2c975f60ae7ead41c76871562f7636c499))
* **grainfmt:** Use only the correct comments for constraints ([#1388](https://github.com/apetcho/grain-lang/issues/1388)) ([91d5cdf](https://github.com/apetcho/grain-lang/commit/91d5cdf63d7be8a68cf613c6ba217c5810cf3920))
* **grainfmt:** Wrap type annotation for a long line let assignment ([#1005](https://github.com/apetcho/grain-lang/issues/1005)) ([963b505](https://github.com/apetcho/grain-lang/commit/963b5053b57aece6b721bd99dbe143b117ad86d7))
...
* **grainlsp:** Send empty response if file cannot be formatted ([#1386](https://github.com/apetcho/grain-lang/issues/1386)) ([38a3f58](https://github.com/apetcho/grain-lang/commit/38a3f58b5cf4b61654cc07f3fad0b9be10abb983))
* **linking:** Close file after reading ([c404fcf](https://github.com/apetcho/grain-lang/commit/c404fcf30bceab2911d3ab0c99f284791c799ca0))
* **lsp:** Always respond to hover request ([#1328](https://github.com/apetcho/grain-lang/issues/1328)) ([fb947b5](https://github.com/apetcho/grain-lang/commit/fb947b5dc47f306f6399d2b4564fe8f33ffd80b1))
* Properly open & close files ([#985](https://github.com/apetcho/grain-lang/issues/985)) ([c404fcf](https://github.com/apetcho/grain-lang/commit/c404fcf30bceab2911d3ab0c99f284791c799ca0))
* **runtime:** Add types to boxed GC functions to avoid weak type errors ([ef0a69f](https://github.com/apetcho/grain-lang/commit/ef0a69fb4418d318b3227e5db7e743a026762274))
...
* **stdlib:** Add bounds checking to Buffer addStringSlice & addBytesSlice ([#1065](https://github.com/apetcho/grain-lang/issues/1065)) ([06fe512](https://github.com/apetcho/grain-lang/commit/06fe512e863aeeb855ccf3e3b83bcd3bc8854723))
* **stdlib:** Align Buffer's `addStringSlice` API with String's `slice` ([#1136](https://github.com/apetcho/grain-lang/issues/1136)) ([0c7cb82](https://github.com/apetcho/grain-lang/commit/0c7cb820d49cda74598680cc614c0d893b4d2b40))
* **stdlib:** Correctly promote numbers to bigints when left-shifting ([#1354](https://github.com/apetcho/grain-lang/issues/1354)) ([5280e98](https://github.com/apetcho/grain-lang/commit/5280e98a91a57fae074299fc7bad3c41f69fa2a3))
...
* **stdlib:** Fix float printing in dtoa ([#1165](https://github.com/apetcho/grain-lang/issues/1165)) ([2987210](https://github.com/apetcho/grain-lang/commit/2987210648873ab474990ff2b7146a489fecb268))
...
* **stdlib:** Make toNumber functions respect Number invariants ([#1347](https://github.com/apetcho/grain-lang/issues/1347)) ([78db882](https://github.com/apetcho/grain-lang/commit/78db8820cf5667a4d6737c9109f4223c1348b245))
* **stdlib:** Prevent addBytesSlice throwing error on empty buffer ([#1394](https://github.com/apetcho/grain-lang/issues/1394)) ([bdd4be4](https://github.com/apetcho/grain-lang/commit/bdd4be46730290908b7b939f41679acce7834167))
...
* **stdlib:** Support arrays of any type in Array rotate ([#1048](https://github.com/apetcho/grain-lang/issues/1048)) ([3ceb1cf](https://github.com/apetcho/grain-lang/commit/3ceb1cf04c1604f49077e8733dcccb6cdaaf9f3a))
* **stdlib:** Support empty arrays in Array rotate ([3ceb1cf](https://github.com/apetcho/grain-lang/commit/3ceb1cf04c1604f49077e8733dcccb6cdaaf9f3a))
...
* **stdlib:** Use explicit exports for Pervasives ([#1301](https://github.com/apetcho/grain-lang/issues/1301)) ([bad5897](https://github.com/apetcho/grain-lang/commit/bad5897062444ec4d4ace805adcd382725b86125))


### Miscellaneous Chores

* **cli:** Remove graceful flag & behavior ([#1275](https://github.com/apetcho/grain-lang/issues/1275)) ([df55898](https://github.com/apetcho/grain-lang/commit/df5589882d12ed35ba448de44e06f434bcf59b07))
* **compiler:** Add interface for compile module to hide resume ([d8ff903](https://github.com/apetcho/grain-lang/commit/d8ff9037fc3148384d2157f76e4394322ba4ed58))
* **compiler:** Disallow end-of-line before `=&gt;` ([#1178](https://github.com/apetcho/grain-lang/issues/1178)) ([8261e73](https://github.com/apetcho/grain-lang/commit/8261e733c9345c690ffc107616512be4eb4c469e))
...
* **compiler:** Refactor HeapAllocated/StackAllocated into Managed/Unmanaged ([#1268](https://github.com/apetcho/grain-lang/issues/1268)) ([1590a37](https://github.com/apetcho/grain-lang/commit/1590a37ca39e39ee40e0f27986fe8195458c3cb9))
* **compiler:** Remove `--lsp` flag from grainc executable ([df91849](https://github.com/apetcho/grain-lang/commit/df91849bd65a729fe4e0b03f51bc6d28017935cb))
...
* **compiler:** Remove decRefIgnoreZeros ([#1068](https://github.com/apetcho/grain-lang/issues/1068)) ([3ae8eaa](https://github.com/apetcho/grain-lang/commit/3ae8eaabad4467304c500c2f0cc9c40749d8513b))
...
* Drop node 14 support ([#1092](https://github.com/apetcho/grain-lang/issues/1092)) ([ef4358f](https://github.com/apetcho/grain-lang/commit/ef4358ff7de14a35edf3e971e04513d497fe1574))
...
* **grainfmt:** Remove stdin formatting support ([d3e7a33](https://github.com/apetcho/grain-lang/commit/d3e7a33b01352a9c2bcc3b17a5b2995451d92221))
...
* **stdlib:** Remove `sum` function from the List module ([#1300](https://github.com/apetcho/grain-lang/issues/1300)) ([9101615](https://github.com/apetcho/grain-lang/commit/9101615688f20310ae32573f93f36cfcf5c69be1))
...
* Switch from yarn to npm ([#1226](https://github.com/apetcho/grain-lang/issues/1226)) ([5ea9274](https://github.com/apetcho/grain-lang/commit/5ea92743a05fffb4298deda64100a3d7fc2259cb))
