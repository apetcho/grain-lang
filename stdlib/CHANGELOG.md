...
## [0.6.0](https://github.com/apetcho/grain-lang/compare/stdlib-v0.5.13...stdlib-v0.6.0) (2023-08-02)
...
* **stdlib:** Ensure Void return for forEach functions in List module ([#1307](https://github.com/apetcho/grain-lang/issues/1307))
* **stdlib:** Provide correct types for BigInt operations ([#1297](https://github.com/apetcho/grain-lang/issues/1297))
...
* **stdlib:** Add explicit void return type on Set.forEach ([#1225](https://github.com/apetcho/grain-lang/issues/1225))
* **stdlib:** Add explicit void return type on Map.forEach ([#1220](https://github.com/apetcho/grain-lang/issues/1220))
* **stdlib:** Add type aliases to regex lib ([#1036](https://github.com/apetcho/grain-lang/issues/1036))
...
* **compiler:** Convert Sys libraries to [@unsafe](https://github.com/unsafe) ([#1272](https://github.com/apetcho/grain-lang/issues/1272)) ([fcdfc2a](https://github.com/apetcho/grain-lang/commit/fcdfc2a815be889d5f0424a04dd5b2373dbd983b))
...
* **stdlib:** Added Bytes.clear function. Avoid allocation in Buffer.clear ([#1124](https://github.com/apetcho/grain-lang/issues/1124)) ([4afd17a](https://github.com/apetcho/grain-lang/commit/4afd17a91e59027fa7af0fe58977bdbe942f8072))
...
* **stdlib:** Convert runtime printing utils to [@unsafe](https://github.com/unsafe) ([#1135](https://github.com/apetcho/grain-lang/issues/1135)) ([403e1d2](https://github.com/apetcho/grain-lang/commit/403e1d20e2082fe2dcd2721f83f6c2b36d4154bf))
...
* **stdlib:** Add explicit void return type on Map.forEach ([#1220](https://github.com/apetcho/grain-lang/issues/1220)) ([ab2066a](https://github.com/apetcho/grain-lang/commit/ab2066aadffa8813344d9df7c7a10ec0f76751b6))
* **stdlib:** Add explicit void return type on Set.forEach ([#1225](https://github.com/apetcho/grain-lang/issues/1225)) ([694e6cf](https://github.com/apetcho/grain-lang/commit/694e6cf8fcd061a77b2915dc0ea9e9b1ae143ae4))
...
* **stdlib:** Buffer.toBytes should not expose the raw instance of Bytes used by the buffer ([#1130](https://github.com/apetcho/grain-lang/issues/1130)) ([d2bb585](https://github.com/apetcho/grain-lang/commit/d2bb585d3e2092f1331a679f4e84a9500b8c87a5))
...
* **stdlib:** Ensure Void return for forEach functions in List module ([#1307](https://github.com/apetcho/grain-lang/issues/1307)) ([31f480c](https://github.com/apetcho/grain-lang/commit/31f480c22e0a39b347fc3a48e1d0b5bd40c2f19e))
...
* **stdlib:** Fix String.encode GC ([#1067](https://github.com/apetcho/grain-lang/issues/1067)) ([0ab38c9](https://github.com/apetcho/grain-lang/commit/0ab38c9f4aa0ee84688ba5c6bec1521b380d38b1))
* **stdlib:** Fixed a memory leak in Buffer.addStringSlice. ([#1122](https://github.com/apetcho/grain-lang/issues/1122)) ([c4e1911](https://github.com/apetcho/grain-lang/commit/c4e19110bd9923e58a7953fcbcef18bf07f3efd6))
* **stdlib:** Fixed length and byteLength for strings over 2GiB. ([#1126](https://github.com/apetcho/grain-lang/issues/1126)) ([08a9487](https://github.com/apetcho/grain-lang/commit/08a948709270a9aa4ac853c2887bc652c4734f36))
* **stdlib:** Fixed memory leak in String.explode ([#1001](https://github.com/apetcho/grain-lang/issues/1001)) ([c479a05](https://github.com/apetcho/grain-lang/commit/c479a05f48abcc4c9e98d5cf0ba698230d41031b))
* **stdlib:** Make Bytes.length handle sizes over 2GiB ([#1123](https://github.com/apetcho/grain-lang/issues/1123)) ([d7386eb](https://github.com/apetcho/grain-lang/commit/d7386eb36c32452d69a734b447015b4db23f1ac4))
...
* **stdlib:** Provide correct types for BigInt operations ([#1297](https://github.com/apetcho/grain-lang/issues/1297)) ([fdd2f1c](https://github.com/apetcho/grain-lang/commit/fdd2f1c49b938a013d6ae199b5e662cb93d051e6))
...
* **stdlib:** Remove intermediate resizes in Buffer.autogrow ([#1125](https://github.com/apetcho/grain-lang/issues/1125)) ([c1695d0](https://github.com/apetcho/grain-lang/commit/c1695d066ccd40b3118c5c870353addeef67bfc1))
...
* **stdlib:** Removed memory leak in Hash module ([#1045](https://github.com/apetcho/grain-lang/issues/1045)) ([01a81c6](https://github.com/apetcho/grain-lang/commit/01a81c6a2573cca94b2d57d0fc70693d39f810a1))
* **stdlib:** Removed memory leaks in Buffer module ([#1047](https://github.com/apetcho/grain-lang/issues/1047)) ([d33017b](https://github.com/apetcho/grain-lang/commit/d33017b37e988d3facbca2e30e3de4fb8c7b5b8a))
...
* **stdlib:** Add type aliases to regex lib ([#1036](https://github.com/apetcho/grain-lang/issues/1036)) ([a926ea5](https://github.com/apetcho/grain-lang/commit/a926ea5cafa18e46487a585abbdf5460b15b4f48))
