...
## [0.8.0](https://github.com/apetcho/grain-lang/compare/stdlib-v0.7.1...stdlib-v0.8.0) (2025-11-07)
...
* **compiler:** Reduce size of runtime heap ([#1807](https://github.com/apetcho/grain-lang/issues/1807))
...
* **compiler:** Reduce size of runtime heap ([#1807](https://github.com/apetcho/grain-lang/issues/1807)) ([246f894](https://github.com/apetcho/grain-lang/commit/246f894951be6ee4f2cb13df3d851583efc1498d))
...
* **runtime:** Simplify `copy` and `fill` polyfills in `Memory` module ([#2148](https://github.com/apetcho/grain-lang/issues/2148)) ([1b3a9f0](https://github.com/apetcho/grain-lang/commit/1b3a9f07bd9749a4f67f12d1b58949476c2d6127))
...
* **stdlib:** Deprecate `Buffer.set` operations in favour of `Bytes.set` ([#2303](https://github.com/apetcho/grain-lang/issues/2303)) ([684df98](https://github.com/apetcho/grain-lang/commit/684df98c8329f6ddd7fab1294e97728a4a44887f))
* **stdlib:** Expose equality operators through `Number` module ([#2296](https://github.com/apetcho/grain-lang/issues/2296)) ([5965dff](https://github.com/apetcho/grain-lang/commit/5965dfff2e43f2f84651c32fe3ef2060613f245d))
...
* **stdlib:** Improve performance in Array & List modules ([#1487](https://github.com/apetcho/grain-lang/issues/1487)) ([2168f6a](https://github.com/apetcho/grain-lang/commit/2168f6ade151548bc655debeb8a1bc09ce87cb77))
* **stdlib:** Improve performance of `flatMap`, `some`, and `every` functions in Array module ([2168f6a](https://github.com/apetcho/grain-lang/commit/2168f6ade151548bc655debeb8a1bc09ce87cb77))
* **stdlib:** Improve performance of `some` and `every` functions in List module ([2168f6a](https://github.com/apetcho/grain-lang/commit/2168f6ade151548bc655debeb8a1bc09ce87cb77))
...
* **stdlib:** Remove parseInt dependency on Pervasives ([#1649](https://github.com/apetcho/grain-lang/issues/1649)) ([9408568](https://github.com/apetcho/grain-lang/commit/9408568a3457c2084afc22f958334e87a4183ccf))
...
* **stdlib:** Simplify `equal` using `Memory.compare` ([#1972](https://github.com/apetcho/grain-lang/issues/1972)) ([dc21976](https://github.com/apetcho/grain-lang/commit/dc219763ebc7bcfcd6c411d7b2b1f152e5e87d6e))
* **stdlib:** Standardize `path` module examples ([#2325](https://github.com/apetcho/grain-lang/issues/2325)) ([c6e3cb0](https://github.com/apetcho/grain-lang/commit/c6e3cb052e5ec69be8037dc63bf39ee2630bbccc))
...
* **stdlib:** Avoid WASI random_get in Hash stdlib during module startup ([#2078](https://github.com/apetcho/grain-lang/issues/2078)) ([7eadfb0](https://github.com/apetcho/grain-lang/commit/7eadfb097e64b043c860d27d21d36d4bfea1ea96))
...
* **stdlib:** Ensure references are retained in unsafe stdlib functions ([#2118](https://github.com/apetcho/grain-lang/issues/2118)) ([639856f](https://github.com/apetcho/grain-lang/commit/639856f9f99edb00bfb19a0ec6f298d48972d3e4))
...
* **stdlib:** Fix overzealous Memory.fill in Buffer.truncate ([#1781](https://github.com/apetcho/grain-lang/issues/1781)) ([e1f24e9](https://github.com/apetcho/grain-lang/commit/e1f24e941a392f1ac6464683d71f87eab6787220))
* **stdlib:** Implement `print` using a single element io vec ([#2066](https://github.com/apetcho/grain-lang/issues/2066)) ([9eeb0f2](https://github.com/apetcho/grain-lang/commit/9eeb0f2edb14facc619c1ede27a5700a27e64e3f))
...
* **stdlib:** Remove memory corruption in File.fdReaddir ([#1573](https://github.com/apetcho/grain-lang/issues/1573)) ([060fc7b](https://github.com/apetcho/grain-lang/commit/060fc7ba4e5c4d86098eafbee09bbce13bca32c3))
* **stdlib:** Return early from `Process.argv()` if length is zero ([#1817](https://github.com/apetcho/grain-lang/issues/1817)) ([8ccea28](https://github.com/apetcho/grain-lang/commit/8ccea288feb7f981adaecd29ba1324fefb192b69))
